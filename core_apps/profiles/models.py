...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_("phone number"), max_length=30, blank=True, null=True)
    ...
    city = models.CharField(verbose_name=_("city"), default="Mumbai", max_length=180, blank=False, null=False)
    profile_photo = models.ImageField(verbose_name=_("profile photo"), default="/profile_default.png")
    twitter_handle = models.CharField(verbose_name=_("twitter_handle"), max_length=20, blank=True, null=True)

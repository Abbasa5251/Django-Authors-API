# Generated by Django 3.2.11 on 2022-07-03 09:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(default='Mumbai', max_length=180, verbose_name='city')),
                ('profile_photo', models.ImageField(default='/profile_default.png', upload_to='', verbose_name='profile photo')),
                ('twitter_handle', models.CharField(blank=True, max_length=20, null=True, verbose_name='twitter_handle')),
